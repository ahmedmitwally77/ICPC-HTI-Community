        ...
        <div className="row  justify-content-between align-items-center">
          ...
          <div className="col-md-3 pb-3 ">
            <div className="social text-center">
              <i class="fa-brands m-auto fa-facebook fs-5 ms-3 text-blue-700"></i>
              <i class="fa-brands m-auto fa-linkedin fs-5 ms-3 text-blue-500"></i>
              <i class="fa-brands m-auto fa-telegram fs-5 ms-3 text-blue-400"></i>
              <i class="fa-brands m-auto fa-instagram fs-5 ms-3 "></i>
            </div>
          </div>
        </div>
