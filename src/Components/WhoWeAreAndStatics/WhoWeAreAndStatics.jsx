...
const AnimatedNumbers = memo(({ value }) => {
...
const WhoWeAreAndStatics = () => {
  ...
  return (
    <div className={`mb-3 relative flex w-full flex-col items-center justify-center py-16`}>
...
export default memo(WhoWeAreAndStatics);