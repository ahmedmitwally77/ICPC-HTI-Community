  ...
  if (isError) return <p>حدث خطأ أثناء تحميل البيانات.</p>;
    ...
    <div className='level'>
        <div className="container py-24 sm:py-16 ">
            ...
            <MainHeading title1="" title2={data?.data.data._doc.title} />
            </div>
            <div className="text flex flex-wrap justify-between items-start">
                <p className='w-1/2 text-xl sm:w-[100%] lg:w-[100%] xl:w-[100%  text-[#7F7F7F] md:w-[100%] mb-5 text-dark/75 relative before:w-[8px] before:bg-[#FEBA12] before:h-full before:absolute before:top-0 pl-5 before:left-0'>{data?.data.data._doc.description}</p>
