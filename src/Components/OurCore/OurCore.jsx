...
const OurCore = () => {
  return (
    <div className='ourCore bg-light shadow-top-only rounded-3xl relative -top-14'>
        ...
        <AnimatedText text="Our Core" ClassName='text-center !text-6xl !text-blue-600 my-16'/>
