        ...
        <AnimatedText text="Levels" ClassName='text-start !text-5xl !text-blue-500 mb-20 z-10'/>
            <div className="row">
                {articles.map(article => (
                    ...
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:1 , y:0}} transition={{duration:1 }} className="box border shadow-xl border-blue p-10 relative rounded-3xl ">
                    ...
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:0.7 , y:0}} transition={{duration:1 }} className="box border shadow-xl border-blue p-10 relative rounded-3xl ">
                        <img className='w-50 absolute  md:hidden -top-28 left-28 m-auto' src={why1} />
                        <h4 className='text-blue-900 fw-bold fs-2 text-center my-4 z-30'>Level 1</h4>
                        <p className='text-dark/75'>Level One builds on the foundations established in
                    ...
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:0.7 , y:0}} transition={{duration:1 }} className="box  border shadow-xl border-blue p-10 relative rounded-3xl ">
                        ...
                        <p className='text-dark/75'>Level Two takes your programming journey to the next 
