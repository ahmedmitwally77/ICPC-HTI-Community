        ...
        <div className="container py-32">
            ...
            <div className="row">
                <motion.div className="col-md-4">
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:1 , y:0}} transition={{duration:0.5 }} className="box p-10 relative rounded-3xl bg-yellow-400">
                ...
                <div  className="col-md-4">
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:1 , y:0}} transition={{duration:1 }} className="box p-10 relative rounded-3xl md:my-20 bg-blue-500">
                        <img className='w-50 absolute md:hidden -top-28 left-28 m-auto' src={why1} alt="" />
                ...
                <div  className="col-md-4">
                    <motion.div initial={{opacity:0 , y:50}} whileInView={{opacity:1 , y:0}} transition={{duration:1.5 }} className="box p-10 relative rounded-3xl bg-yellow-400">
                        <img className='w-50 absolute md:hidden -top-28 left-28 m-auto' src={why1} alt="" />
            ...
            <div className="row pt-16 justify-center align-items-center">
                ...
                <div className="col-md-6">
                    <motion.img initial={{opacity:0 , y:50}} whileInView={{opacity:1 , y:0}} transition={{duration:1 }} className='w-100' src={what} alt="" />
                </div>
            </div>
        </div>
    </div>
