...
const Sheets_Contest = () => {


    const sheets =["sheet1" , "sheet2" , "sheet3" , "sheet4" , "sheet5" , "sheet6" , "sheet6", "sheet6", "sheet6"]
            ...
            <thead className="text-lg text-[#3A3A3A] uppercase dark:text-gray-400">
              <tr>
                ...
                {sheets.map((sheet, index) => (
                  <th key={index} scope="col" className="px-6 py-3 min-w-[180px] whitespace-nowrap">
                    {sheet}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              {currentRows.map((data, index) => (
                ...
                >
                  ...
                  {sheets.map((sh, idx) => (
                    <td key={idx} className="px-6 text-[#656565]">
                      {data[sh]}
                    </td>
                  ))}
                </tr>
